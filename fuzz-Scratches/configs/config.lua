...
Config.Settings = {
    Framework = "qb", -- "qb" or "esx" (ESX SUPPORT REMOVED)
...
Config.NeedsCoin = true -- REQUIRES ITEM TO SCRATCH OFF 
Config.scratchcoin = 'luckypenny' -- SCRATCH OFF ITEM
Config.removecoin = true -- REMOVES COIN ON SCRATCH OFF (IF CONFIG.NeedsCoin = false set this to false)
